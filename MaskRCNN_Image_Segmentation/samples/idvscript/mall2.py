...
class IDVDataset(utils.Dataset):
    ...
    def load_idv(self, dataset_dir, subset):
        ...
        self.add_class("idv", 1, "1")
        self.add_class("idv", 2, "2")
        self.add_class("idv", 3, "3")
        self.add_class("idv", 4, "4")
        self.add_class("idv", 5, "5")
        self.add_class("idv", 6, "6")
        self.add_class("idv", 7, "7")
        self.add_class("idv", 8, "8")
        self.add_class("idv", 9, "9")
        self.add_class("idv", 10, "10")
        self.add_class("idv", 11, "11")
        self.add_class("idv", 12, "12")
